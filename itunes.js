var pathToAPI = 'https://far-off-lifts.000webhostapp.com/api.php'; // replace with your path to the api.php file
                ...
                if (data.error) {
                    ...
                    if (!data.length) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            var html = '<div><h3 style="text-align: center;">'+result.title+'</h3>';
                            var genius_url = result.url.replace("600x600bb", "1000x1000bb");
                            var high_url = result.url.replace("600x600bb", "10000x10000bb");
                            genius_url = genius_url.replace("jpg", "png");
                            high_url = high_url.replace("jpg", "png");
                            html += '<p class="imgurl"><a href="'+genius_url+'" target="_blank">Best resolution for Genius</a> | <a href="'+high_url+'" target="_blank">Highest Resolution</a></p>';
                            html += '<p class="imgurl"><a href="'+genius_url+'" target="_blank"><img src="'+genius_url+'" alt="iTunes Artwork for \''+result.title+'\'" width="'+result.width+'" height="'+result.height+'"></a></p>';
                            html += '</div>';
